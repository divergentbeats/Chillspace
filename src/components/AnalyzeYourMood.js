...
const AnalyzeYourMood = () => {
    ...
    const analyzeMood = async () => {
        ...
        const payload = {
            contents: [{
                parts: [{
                    text: `
                        You are a supportive and empathetic mental wellness AI for youth.
                        The user's input is their raw thoughts or a "rant."
                        Analyze the user's text and respond with a JSON object.
                        The JSON object must have five fields:
                        1. "stressLevel": An integer from 0 to 100 representing the level of stress.
                        2. "moodSummary": A concise summary of the user's emotional state.
                        3. "keyEmotions": An array of 3-5 keywords that describe the most prominent emotions.
                        4. "helpfulSuggestions": An array of three short, actionable, and encouraging suggestions.
                        5. "helpfulDialogue": A short, empathetic, and encouraging response to the user's text.
                        Respond in ${language}.
            ...
            generationConfig: {
                ...
                responseSchema: {
                    ...
                    properties: {
                        ...
                        "helpfulSuggestions": { "type": "ARRAY", "items": { "type": "STRING" } },
                        "helpfulDialogue": { "type": "STRING" }
                    },
                    required: ["stressLevel", "moodSummary", "keyEmotions", "helpfulSuggestions", "helpfulDialogue"]
                }
            }
        };
    ...
    const generateAffirmation = async () => {
        ...
        const payload = {
            contents: [{
                parts: [{
                    text: `Generate a single, uplifting daily affirmation for a young person. Respond in ${language}. If possible, make it relevant to the user's previous text: "${userText}"`
                }]
            }]
        };
    ...
    const playDialogue = async () => {
        ...
        const payload = {
            ...
            generationConfig: {
                ...
                speechConfig: {
                    voiceConfig: {
                        prebuiltVoiceConfig: { voiceName: ttsVoiceMap[language] || "Kore", languageCode: language }
                    }
                }
            },
    ...
    const generateQuiz = async () => {
        ...
        const payload = {
            contents: [{
                parts: [{
                    text: `Generate a JSON array of 5 short, introspective questions for a mental wellness quiz in ${language}. Each object in the array should have a 'question' string and a unique 'id' number. The questions should encourage reflection on feelings, stress, and well-being. Focus on open-ended questions. Example format: [{"question": "What...", "id": 1}]`
                }]
            }],
            generationConfig: {
                responseMimeType: "application/json",
    ...
    return (
        <div className={`flex items-center justify-center min-h-screen p-4 bg-gray-900`}>
            <div className="bg-gray-800 p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-2xl flex flex-col items-center space-y-8 border border-gray-700">
                ...
                <header className="text-center space-y-2 w-full flex flex-col items-center">
